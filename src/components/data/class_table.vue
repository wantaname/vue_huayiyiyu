<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>義類表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片 -->
    <el-card class="box-card">
      <el-row :gutter="2">
        <el-col :span="2">
           <el-select  v-model="queryClass.select" placeholder="请选择">
              ...
              <el-option value="name" label="義類" ></el-option>
      ...
      <el-table :data="classList" stripe style="width: 100%" border>
        ...
        <el-table-column prop="name" label="義類"></el-table-column>
...
export default {
  ...
  methods: {
    getClassList() {
        ...
        this.$http.get(`/data/class`, {
          params: this.queryClass
        })
        .then((res)=> {
          if (res.status !== 200) return this.message.error("獲取義類失敗!");
